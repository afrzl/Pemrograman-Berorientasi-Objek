...
public class Pengawas extends Petugas{
    ...
    public Pengawas(String nama, LocalDate tanggalPencacahan, String tandaTangan){
        super();
        this.nama = nama;
    ...
    public void setTanggalPencacahan(LocalDate tanggalPencacahan){
        if (tanggalPencacahan != null) {
            if (!tanggalPencacahan.equals(LocalDate.now())) {
                System.out.println("Warning: Tanggal pengawasan bukan tanggal sekarang.");
            } else {
            this.tanggalPencacahan = tanggalPencacahan;
            }
        } else {
            throw new IllegalArgumentException("Tanggal pengawasan tidak valid");
        }
    }
    ...
    public void setTandaTangan(String tandaTangan){
        ...
        if (!tandaTangan.trim().isEmpty()) {
            ...
            throw new IllegalArgumentException("Error: Tanda tangan tidak boleh kosong.");
        }
    }
}
